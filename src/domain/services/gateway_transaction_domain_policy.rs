//! Domain policy for GatewayTransaction aggregate
//!
...
/// enforcement, implement `backbone_core::ServiceLifecycle<GatewayTransaction>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type GatewayTransactionDomainPolicy = PermitAllPolicy<GatewayTransaction>;
