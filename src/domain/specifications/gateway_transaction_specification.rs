//! Specifications for GatewayTransaction aggregate
//!
...
// Each predicate implements `Specification<GatewayTransaction>` and can be combined
...
//
// pub struct ActiveGatewayTransactionSpec;
// impl Specification<GatewayTransaction> for ActiveGatewayTransactionSpec {
//     fn is_satisfied_by(&self, e: &GatewayTransaction) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
