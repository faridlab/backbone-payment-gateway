//! Specifications for PaymentGatewayProvider aggregate
//!
...
// Each predicate implements `Specification<PaymentGatewayProvider>` and can be combined
...
//
// pub struct ActivePaymentGatewayProviderSpec;
// impl Specification<PaymentGatewayProvider> for ActivePaymentGatewayProviderSpec {
//     fn is_satisfied_by(&self, e: &PaymentGatewayProvider) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
